...
var Center = React.createClass({displayName: 'Center',
 getInitialState: function() {
  ...
  render: function() {
    ...
    var play = React.DOM.button( {className:(value > 100 && value < 1600 && this.props.status) ? "btn btn-default play" : "btn btn-success play", onClick:this.play, disabled:(value > 100 && value < 1600 && this.props.status) ? false : true} , "Play")
    return (
