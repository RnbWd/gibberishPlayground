...
var Center = React.createClass({displayName: 'Center',
 getInitialState: function() {
    return {value: "432", sine: 'off', right: -1, left: 1}
  },
  ...
  render: function() {
    ...
    sineL.frequency = parseInt(value) + this.state.left;
    sineR.frequency = parseInt(value) + this.state.right;

    var inputL = React.DOM.input( {id:"textInputL", type:"text", className:"form-control", value:parseInt(value)+this.state.right, onChange:this.handleInput} )
    var inputR = React.DOM.input( {id:"textInputR", type:"text", className:"form-control", value:parseInt(value)+this.state.left, onChange:this.handleInput} )
