...
var Center = React.createClass({displayName: 'Center',
 getInitialState: function() {
  ...
  render: function() {
    ...
    var play = React.DOM.button( {className:(value > 100 && value < 1600 && this.props.status) ? "btn btn-success play" : "btn btn-default play", onClick:this.play, disabled:(value > 100 && value < 1600 && this.props.status) ? false : true} , "Play")
    return (
