...
var Center = React.createClass({displayName: 'Center',
 getInitialState: function() {
  ...
  render: function() {
    ...
    var mic = React.DOM.button( {className:"btn btn-default microphone", onClick:this.microphone} , "Microphone")
    ...
    return (
      ...
      React.DOM.h1(null, "Gibberish Playground"),
          input,
          paragraph,
        React.DOM.button( {className:"btn btn-default play", onClick:this.play, disabled:(value > 100 && value < 1600 && this.props.status) ? false : true} , "Play"),";"
