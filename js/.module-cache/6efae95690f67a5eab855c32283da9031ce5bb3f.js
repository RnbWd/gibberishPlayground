 ...
 getInitialState: function() {
  ...
  handleInputR: function(event) {
    var input = event.target.value;
      (input != 0) ? this.setState({right: event.target.value}) : '';
  },
   handleInputL: function(event) {
    var input = event.target.value;
      (input != 0) ? this.setState({left: event.target.value}) : '';
  },
  ...
  render: function() {
    ...
    var inputL = React.DOM.input( {id:"textInputL", type:"text", className:"form-control", value:this.state.right, onChange:this.handleInputL} )
    var inputR = React.DOM.input( {id:"textInputR", type:"text", className:"form-control", value:this.state.left, onChange:this.handleInputR} )
