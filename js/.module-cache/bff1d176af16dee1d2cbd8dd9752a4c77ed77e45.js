...
var Center = React.createClass({displayName: 'Center',
 getInitialState: function() {
  ...
  render: function() {
    ...
    var play = React.DOM.button( {className:(this.props.status) ? "btn btn-success play" : "btn btn-danger play", onClick:this.play, disabled:(value > 100 && value < 3000 && this.props.status) ? false : true} , "Play")
    return (
