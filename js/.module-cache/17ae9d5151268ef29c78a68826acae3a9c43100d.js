 ...
 getInitialState: function() {
  ...
  handleInputR: function(event) {
    var input = event.target.value;
      (/[0-9]/g.test(input)) ? this.setState({right: input}) : '';
  },
   handleInputL: function(event) {
    var input = event.target.value;
      (/[0-9]/g.test(input)) ? this.setState({left: input}) : '';
  },
  ...
  render: function() {
    ...
    var inputL = React.DOM.input( {id:"textInputL", type:"text", className:"form-control", value:this.state.left, onChange:this.handleInputL} )
    var inputR = React.DOM.input( {id:"textInputR", type:"text", className:"form-control", value:this.state.right, onChange:this.handleInputR} )
