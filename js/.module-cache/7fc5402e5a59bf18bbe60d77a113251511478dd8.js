...
var Center = React.createClass({displayName: 'Center',
 getInitialState: function() {
  ...
  render: function() {
    ...
    var left = React.DOM.button( {className:(this.props.status) ? "btn btn-success pull-left" : "btn btn-danger pull-left", onClick:this.play, disabled:(this.props.status) ? false : true} , "Left")
    var right = React.DOM.button( {className:(this.props.status) ? "btn btn-success pull-right" : "btn btn-danger pull-right", onClick:this.playR, disabled:(this.props.status) ? false : true} , "Right")
